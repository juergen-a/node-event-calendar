...
function doOnIncomeMessage(req, res) {
  // GET-request - !ok
  if (req.method !== 'GET') {
    res.statusCode = 404;
...
// Create server object - EventEmitter
const server = http.createServer(doOnIncomeMessage);

// Assign port to server in development
server.listen(3000);
